...
// const myName = ['ronaldo','messi','ibrahimovic','henry','ronaldodinho','kaka','robinho','rivaldo'];
// const filterItem = (char) => {
//  return myName.filter(val => val.indexOf(char) > -1);
// };

// console.log(filterItem('si'));
